...
const handleErrors = (err) => {
    ...
    // validation errors
    if (err.message.includes('la validación del pedido falló') || err.message.includes('Validación fallida')) {
...
const edit = async (req, res) => {
    ...
    res.render('pages/product/edit-product', { title: 'Editar pedido', product: item[0], suppliers: suppliers, categories: categories })
}
